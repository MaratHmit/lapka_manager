                        ...
                        .col-md-4
                            .form-group(class='{ has-error: error.code }')
                                ...
                                .input-group
                                    ...
                                    span.input-group-addon(onclick='{ generateCode }')
                                        i.fa.fa-random
                        ...
                        .col-md-6
                            .form-group
                                ...
                                .input-group
                                    ...
                                    span.input-group-addon(if='{ checkPermission("contacts", "1000") }', onclick='{ changeUser }')
                                        i.fa.fa-list
                                    span.input-group-addon(onclick='{ removeUser }')
                                        i.fa.fa-remove
                    .row
                        .col-md-12
                            .form-group
